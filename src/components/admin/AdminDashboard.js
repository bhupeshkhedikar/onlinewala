...
import AdminUdhari from "./AdminUdhari";
            ...
            (item) => (
              ...
              >
                ...
                {item.id ===
                  ...
                  <span className="udhari-menu-dot">
                    ₹
                  </span>
...
>
  <AdminWalletManager />
          ...
          <section
            id="admin-udhari"
            className="admin-section udhari-admin-section"
          >

            <div className="admin-module-header udhari-admin-header">
              ...
              <div>
                ...
                <p>
                  Users ची उधारी, payment, due date आणि payment history व्यवस्थापित करा.
                </p>

              </div>


              <div className="udhari-admin-header-icon">
                💰
              </div>
          ...
          >
            ...
            <div className="admin-module-header withdrawal-header">
              ...
              <div>
                ...
                <p>
                  Review, approve, reject and manage user withdrawal requests.
                </p>
