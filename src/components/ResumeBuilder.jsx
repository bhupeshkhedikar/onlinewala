...
export default function ResumeBuilder() {
  ...
  const [data, setData] = useState({
    ...
    objective:
      "To secure a challenging position in a reputable organization to expand my learnings, knowledge, and skills while contributing to the growth and success of the company.",
  ...
  const addPersonalInfo = () => {
    setData({
      ...data,
      personalInfo: [...data.personalInfo, { id: Date.now(), label: "", value: "" }]
    });
  };
  ...
  const removePersonalInfo = (id) => {
    setData({
      ...data,
      personalInfo: data.personalInfo.filter((item) => item.id !== id)
    });
  };
  ...
  const addEducation = () => {
    setData({
      ...
      education: [
        ...data.education,
        { id: Date.now(), exam: "", board: "", year: "", percentage: "" }
      ]
    });
  };
  ...
  // 🔥 GUARANTEED SINGLE-PAGE PDF EXPORT
        ...
        {activeTab === "edit" && (
          <div className="form-pane">
            <div className="form-header">
              ...
              <p>Fill out the fields below to instantly build your resume.</p>
            </div>
              ...
              {data.personalInfo.map((item) => (
                <div className="dynamic-row" key={item.id}>
                  <input
                    ...
                    value={item.label}
                    onChange={(e) =>
                      handlePersonalChange(item.id, "label", e.target.value)
                    }
                    placeholder="Label (e.g. GENDER)"
                  />
                  <input
                    type="text"
                    value={item.value}
                    onChange={(e) =>
                      handlePersonalChange(item.id, "value", e.target.value)
                    }
                    placeholder="Value"
                  />
                  <button
                    className="remove-btn"
                    onClick={() => removePersonalInfo(item.id)}
                  >
                    ✕
                  </button>
                </div>
              ))}
              <button className="add-btn" onClick={addPersonalInfo}>
                + Add Personal Info
              </button>
            </div>
          ...
          <div className="preview-pane">
            ...
            <div className="a4-wrapper">
              <div className="a4-paper" ref={resumeRef}>
                {/* 🖼️ INNER BORDER BOX */}
                <div className="resume-inner-border">
                  ...
                  <div className="footer-info">
                    <div className="left-footer">
                      ...
                      <p>
                        {data.placeLabel} {data.placeValue}
                      </p>
                    </div>
